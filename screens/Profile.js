    ...
    <SafeAreaView style={([styles.container], {marginTop: 30})}>
      ...
      <View style={styles.userInfoSection}>
        <View style={{flexDirection: 'row', marginTop: 15}}>
          <Avatar.Image
            source={{
              uri: 'https://avatarfiles.alphacoders.com/256/256957.jpg',
            }}
            size={80}
          />
          <View style={{marginLeft: 20}}>
            <Title style={[styles.title, {marginTop: 25, marginBottom: 5}]}>
              Pushpraj Singh
            </Title>
          </View>
        </View>
      ...
      <View style={styles.userInfoSection}>
        <View style={styles.row}>
          ...
          <Text style={{color: '#777777', marginLeft: 20}}>
            Bhatgaon, Surajpur, Chhattisgarh
          </Text>
        </View>
        <View style={styles.row}>
          <Icon name="phone" color="#777777" size={20} />
          <Text style={{color: '#777777', marginLeft: 20}}>+91-7723095237</Text>
        </View>
        <View style={styles.row}>
